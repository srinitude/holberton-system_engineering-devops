...
<div class="col-sm-1">
<button class="add_task_url" data-task-id="1754" data-task-requesting="0" data-user-id="214" type="button">
...
<div class="col-sm-1">
<button class="add_task_url" data-task-id="1755" data-task-requesting="0" data-user-id="214" type="button">
<span aria-hidden="true" class="glyphicon glyphicon-plus"></span>
</button>
</div>
</div>
...
<div class="col-sm-1">
<button class="add_task_url" data-task-id="1756" data-task-requesting="0" data-user-id="214" type="button">
<span aria-hidden="true" class="glyphicon glyphicon-plus"></span>
</button>
</div>
</div>
...
<div class="col-sm-1">
<button class="add_task_url" data-task-id="1793" data-task-requesting="0" data-user-id="214" type="button">
<span aria-hidden="true" class="glyphicon glyphicon-plus"></span>
</button>
</div>
</div>
